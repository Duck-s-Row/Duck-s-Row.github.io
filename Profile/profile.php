...
<body>
    <section class="main">
        <div class="user_choices">
            ...
            <button class="chooice"><a href="#"><i class="fa-solid fa-right-from-bracket"></i>&nbsp;Logout</a></button>
        </div>
            ...
            <form action="" method="post">
                ...
                <div class="c1">
                    <div class="c1f">
                        ...
                        <input id="firstName" class="firstName" type="text" value="Kareem"  name="firstName">
                    </div>

                    <div class="c1l">
                        <label class="llastName">Last Name : </label><br>
                        <input id="lastName" class="lastName" type="text" value="Abdallah"  name="lastName">
                    </div>
                </div>
                ...
                <div class="c2">
                    ...
                    <input class="email" type="email" value="ducksrow100@gmail.com">
                </div>              
                <!-- end of second row -->
                ...
                <div class="c3">
                    <div class="c3f">
                        ...
                        <input id="phone" class="phone" type="tel" value="01556892517"  name="phone">
                    </div>
                    ...
                    <div class="gender">
                        ...
                        <div>
                            ...
                            <input id="male" class="male" type="radio" checked="checked"  name="gender">
                        </div>
                        <div>
                            <label class="gfemale">Female</label>
                            <input id="female" class="female" type="radio"  name="gender">
                        </div> 
                    </div>
                </div>
                <!-- end of third row -->
