...
<head>
    ...
    <link rel="stylesheet" href="pro9.css">
    <title>Profile</title>
    <style>
    ...
    <section class="main">
        <div class="user_choices">
            ...
            <div class="btns">
                ...
                <button class="chooice" onclick="window.location.href = '../Log_out/index.php';"><a href="#"><i class="fa-solid fa-right-from-bracket"></i>&nbsp;Logout</a></button>
            </div>
        </div>
