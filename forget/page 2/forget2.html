...
<body>
    ...
    <section class="forget-password-ways">
        <div class="check-box">
            <form name="a">
                <button class="phone"><input type="radio" name="kind" value="phone" onchange="checkKind()"><label>Confirm via SMS<div class="font"><font >+20********</font></div></label></button><br>
                <button class="mail"><input type="radio" name="kind" value="mail" onchange="checkKind()"><label>Confrim via E-mail<div class="font"><font >*******@gmail.com</font></div></label></button>
            </form>
        </div>
        <!-- <div>
